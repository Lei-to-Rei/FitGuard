...
@Database(entities = [FoodEntry::class, UserProfile::class, WaterIntakeEntry::class], version = 8, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_7_8 = object : Migration(7, 8) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE user_profiles ADD COLUMN restingHrvRmssd REAL NOT NULL DEFAULT 0.0")
            }
        }
